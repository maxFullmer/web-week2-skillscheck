...
// Code Here
let filtered = myNumbers.filter(y => y > 100);
//////////////////PROBLEM 16////////////////////

// Next up, reduce to get the total of the array. call the new array 'total'

// Code Here
let total = myNumbers.reduce((runningTotal, z) => runningTotal + z,0);
//////////////////PROBLEM 17////////////////////
...
myNumbers.forEach(function(item) {
	myNumbersIndex.push(myNumbers.indexOf(item));
})
//////////////////PROBLEM 18////////////////////
...
// Code Here
const forTheLoveOfGeorge = notGeorge.map(() => {return 'George'});
//////////////////PROBLEM 19////////////////////
...
// Code Here
const totallyAwesome = people.reduce((runningTotal2,person) => runningTotal2 + person.awesomeLevel,0);